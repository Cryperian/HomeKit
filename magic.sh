...
sudo wget https://raw.githubusercontent.com/Cryperian/tttt/main/mosquitto.conf -P /home/cryperian/mosquitto/config/
...
echo " "
sudo docker run --name zigbee2mqtt --device=/dev/ttyUSB0 --net host --restart unless-stopped -v $(pwd)/data:/app/data -v /run/udev:/run/udev:ro -e TZ=Asia/Yerevan koenkk/zigbee2mqtt
echo "----------------------------------------------------------------"
